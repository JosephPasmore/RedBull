public class LocationReview {
    ...
    // LocationReviewBuilder can initiate the writableReview class instance
    private LocationReview(LocationReview.LocationReviewBuilder builder) {
    ...
    public static class LocationReviewBuilder()

    {
        ...
        public LocationReview build(){
        return new LocationReview(this);
    }
    }
}
